            ...
            <div class="row">
                <div class="col-lg-3 col-md-2 col-sm-12 col-xs-12 hidden-xs hidden-sm">
                    <div class="gc_header_wrapper">
                        <div class="gc_logo">
                            <a href="index.php"><img style="width: 100px" src="images/content/logo.jpeg" alt="Logo" title="Grace Church" class="img-responsive"></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="header-area hidden-menu-bar stick" id="sticker">
                        ...
                        <div class="mainmenu">
                            <ul>
                                ...
                                <li class="gc_main_navigation parent"><a href="about.php" class="gc_main_navigation">About Us</a></li>
                                <li class="gc_main_navigation parent"><a href="ministry.php" class="gc_main_navigation">Ministry</a></li>
                                <li class="gc_main_navigation parent"><a href="beliefs.php" class="gc_main_navigation">Our Beliefs</a></li>
                                <li class="gc_main_navigation parent"><a href="values.php" class="gc_main_navigation">Our Values</a></li>
                                <li class="gc_main_navigation parent"><a href="gallery.php" class="gc_main_navigation">Gallery</a> </li>
                                <li class="gc_main_navigation parent"><a href="contactus.php" class="gc_main_navigation">Contact Us</a></li>
                            </ul>
                        </div>
                        <!-- mainmenu end -->
                                    ...
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="cd-dropdown-wrapper">
                                            ...
                                            <nav class="cd-dropdown">
                                                <h2><a href="#">ACF<span>Fellowship</span></a></h2>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="gc_share_box">
                                    <ul>
                                        <li><a href="https://www.facebook.com/people/UZIMA-Church-Antioch-Community-Fellowship/100023066550540/?mibextid=LQQJ4d" title="Facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
