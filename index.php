...
<ul>	<!-- SLIDE  -->
 ...
 data-verticalalign="top"
		...
		<div class="tp-caption   tp-resizeme" 
			...
			style="z-index: 7; white-space: normal; font-size: 40px; line-height: 24px; font-weight: 400; color: #FFFFFF; letter-spacing: 5px; display: block;font-family:Oswald;text-transform:uppercase;">
			ACF
			</div>
		...
		<div class="tp-caption   tp-resizeme" 
			 ...
			 data-y="['top','top','top','top']" data-voffset="['0','170','170','167']" 
						data-fontsize="['66','50','40','40']"
			data-lineheight="['70','65','60','60']"
			data-letterspacing="['5','5','4','3']"
			data-width="none"
			data-height="none"
		...
		<div class="tp-caption   tp-resizeme" 
			...
			style="z-index: 8; width:100%; white-space: normal; font-size: 40px; line-height: 90px; font-weight: 900;  display: block; font-family: 'Droid Serif', serif;">
            The Body meets YOU
			</div>
			
			<div class="tp-caption   tp-resizeme et_slider_btn_wrapper" 
			 id="slide-974-layer-4" 
			...
			data-frames='[{"delay":"+1990","speed":2000,"frame":"0","from":"opacity:0;","color":"#ffffff","to":"o:1;","ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"frame":"999","color":"transparent","to":"opacity:0;","ease":"Power3.easeInOut"}]'
 ...
 data-verticalalign="top"
		...
		<div class="tp-caption   tp-resizeme" 
			...
			style="z-index: 8; width:100%; white-space: normal; font-size: 40px; line-height: 90px; font-weight: 900;  display: block; font-family: 'Droid Serif', serif;">
            The Holy Spirit reaches YOU,
			</div>
			
			<div class="tp-caption   tp-resizeme et_slider_btn_wrapper" 
			 id="slide-974-layer-15" 
			 data-x="['left','left','left','left']" data-hoffset="['0','540','814','633']" 
			 data-y="['top','top','top','top']" data-voffset="['0','440','410','298']" 			
			data-width="100%"
			data-height="none"
 ...
 data-verticalalign="top"
		...
		<div class="tp-caption   tp-resizeme" 
			...
			style="z-index: 8; width:100%; white-space: normal; font-size: 40px; line-height: 90px; font-weight: 900;  display: block; font-family: 'Droid Serif', serif;">
            The Word teaches YOU
			</div>
			
			<div class="tp-caption   tp-resizeme et_slider_btn_wrapper" 
			 id="slide-974-layer-21" 
			 data-x="['left','left','left','left']" data-hoffset="['0','540','814','633']" 
			 data-y="['top','top','top','top']" data-voffset="['0','440','410','298']" 			
			data-width="100%"
			data-height="none"
...
<div class="tp-bannertimer tp-bottom" style="display:none;"></div>	</div>
...
<div class="gc_event_main_wrapper">
	<div class="container">
			<div class="gc_player_left_section_wrapper">
				<div class="gc_event_sec_wrapper">
					<div class="row">
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">

							<div class="gc_event_heading_wrapper">
								<h3>Matthew 24:14</h3>
							</div>
						</div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="gc_event_bottom_cont">
								...
								<h2>And this Gospel of the Kingdom will be preached in the whole world as a testimony to all nations</h2>
			...
			<div class="gc_player_right_section_wrapper">
				<div class="gc_player_main_wrapper">
					<div class="gc_player_img_overlay"></div>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<p style="color: white">
                                Antioch Community Fellowship (ACF) is the place for you, your family and friends -
                                a place to worship and learn - a place to be cared for and accepted - a place to call HOME.
                                Sound Bible teaching, caring people and a cheerful, inviting place to learn makes the difference.
                                The warmth and welcome of Antioch's people, both young and old - a fellowship centred on Christ will make you feel
                                at home. So, if you don't have a church home, come and grow with us.
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="gc_about_cont_wrapper">
                    ...
                    <div class="gc_about_icons_cont_wrapper">
                        <h3><a href="#">The Body meets YOU</a></h3>
                    </div>
                </div>
                <div class="gc_about_cont_wrapper">

                    <div class="gc_about_icons_cont_wrapper">
                        <h3><a href="#">The Holy Spirit reaches YOU</a></h3>
                    </div>
                </div>
                <div class="gc_about_cont_wrapper">

                    <div class="gc_about_icons_cont_wrapper">
                        <h3><a href="#">The Word teaches YOU,</a></h3>
                    </div>
                </div>
                <div class="gc_about_cont_wrapper">

                    <div class="gc_about_icons_cont_wrapper">
                        <h3><a href="#">The Five Fold Ministry equips YOU, and</a></h3>
                    </div>
                </div>
                <div class="gc_about_cont_wrapper">

                    <div class="gc_about_icons_cont_wrapper">
                        <h3><a href="#"> GOD sends YOU to make a difference!</a></h3>
                    </div>
                </div>
...
<div class="gc_counter_main_wrapper">
	<div class="gc_counter_cont_wrapper">
		...
		<div class="count-description">
			<span class="timer2">To begin</span>
	...
	<div class="gc_counter_cont_wrapper2">
		...
		<div class="count-description">
			<span class="timer2">To belong</span>
	...
	<div class="gc_counter_cont_wrapper3">
		...
		<div class="count-description">
			<span class="timer2">To believe</span>
	...
	<div class="gc_counter_cont_wrapper4">
		...
		<div class="count-description">
			<span class="timer2">To become</span>
		</div>
	</div>
</div>
</div>
							...
							<div class="gc_testi_slider_cont_wrapper">
								...
								<div class="gc_testi_slider_content_wrapper">
									<p style="color: white">
                                        ...
                                        - a place to worship and learn - a place to be cared for and accepted - a place to call HOME.
                                        Sound Bible teaching, caring people and a cheerful, inviting place to learn makes the difference.
                                        The warmth and welcome of Antioch's people,
                                        both young and old - a fellowship centred on Christ will make you feel at home.
                                        So, if you don't have a church home, come and grow with us.
                                    </p>
								</div>
